(() => {
	...
	function r(t) {
		...
		var s = (o[t] = { exports: {} });
		return n[t](s, s.exports, r), s.exports;
	}
	(r.m = n),
		(r.d = (t, e) => {
			for (var n in e)
		...
		(r.l = (n, o, s, i) => {
			if (t[n]) t[n].push(o);
				...
				if (void 0 !== s)
					for (
						...
						if (
							...
							p.getAttribute('data-webpack') == e + s
						) {
							a = p;
							break;
						}
				...
				a ||
					...
					a.setAttribute('data-webpack', e + s),
					(a.src = n)),
					(t[n] = [o]);
				var u = (e, o) => {
		...
		(() => {
			...
			r.f.j = (e, n) => {
				...
				if (0 !== o)
					if (o) n.push(o[2]);
						...
						var s = new Promise((n, r) => (o = t[e] = [n, r]));
						n.push((o[2] = s));
						var i = r.p + r.u(e),
							a = new Error();
						r.l(
			...
			var e = (e, n) => {
					...
					for (e && e(n); d < i.length; d++)
						(s = i[d]), r.o(t, s) && t[s] && t[s][0](), (t[s] = 0);
				},
				n = (self.webpackChunklesson21_javascript_tooling =
	...
	class a {
		...
		constructor(t) {
			...
			console.log(this.projects), this.connectDroppable();
		}
		connectDroppable() {
			const t = document.querySelector(`#${this.type}-projects ul`);
			t.addEventListener('dragenter', (e) => {
				'text/plain' === e.dataTransfer.types[0] &&
					(t.parentElement.classList.add('droppable'), e.preventDefault());
			}),
				t.addEventListener('dragover', (t) => {
					'text/plain' === t.dataTransfer.types[0] && t.preventDefault();
				}),
	...
	(class {
		...
		static startAnalytics() {
			...
			(t.src = 'assets/scripts/Utility/Analytics.js'),
				(t.defer = !0),
